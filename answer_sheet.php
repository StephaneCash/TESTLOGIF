...
?>
<title><?php echo $quiz['title'] ?> | Réponse</title>
</head>
...
<body>
    ...
    <div class="container-fluid admin">
        <div class="col-md-12 alert alert-primary"><?php echo $quiz['title'] ?> |
            <?php echo $quiz['qpoints'] . ' Pondération' ?></div>
        <br>
        <div class="card">
            <div class="card-body">
                            ...
                            <ul class='list-group mt-4 mb-4'>
                                ...
                                <li class="answer list-group-item">
                                    <label><input type="radio" name="option_id[<?php echo $row['id'] ?>]"
                                            value="<?php echo $orow['id'] ?>"> <?php echo $orow['option_txt'] ?></label>
                                </li>
                                <?php } ?>
        ...
        $.ajax({
            ...
            success: function(resp) {
                if (typeof resp != undefined) {
                    ...
                    if (resp.status == 1) {
                        alert('Merci, votre résultat est :  ' + resp.score)
