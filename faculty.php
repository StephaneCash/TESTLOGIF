                            ...
                            <td>
                                <center>
                                    <button class="btn btn-sm btn-outline-primary edit_faculty"
                                        ...
                                        Editer</button>
                                    <button class="btn btn-sm btn-outline-danger remove_faculty"
        ...
        <div class="modal-dialog modal-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title" id="myModallabel">Ajout d'un new prof</h4>
...
$(document).ready(function() {
    ...
    $('#new_faculty').click(function() {
        $('#msg').html('')
        $('#manage_faculty .modal-title').html('Ajout d\'un new prof')
        ...
        $.ajax({
            ...
            success: function(resp) {
                if (typeof resp != undefined) {
                    ...
                    $('#manage_faculty .modal-title').html('Editer prof')
                    $('#manage_faculty').modal('show')
    ...
    $('.remove_faculty').click(function() {
        var id = $(this).attr('data-id')
        var conf = confirm('Etes-vous sûr de supprimer cette donnée ?');
        if (conf == true) {
            $.ajax({
    ...
    $('#faculty-frm').submit(function(e) {
        ...
        $('#faculty-frm [name="submit"]').html('Patienter...')
        $('#msg').html('')
        ...
        $.ajax({
            ...
            error: err => {
                ...
                $('#faculty-frm [name="submit"]').html('Enregistrer')
            },
            success: function(resp) {
                if (typeof resp != undefined) {
                    resp = JSON.parse(resp)
