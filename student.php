...
<body>
    ...
    <div class="container-fluid admin">
        <div class="col-md-12 alert alert-primary">Liste de candidats </div>
        <button class="btn btn-primary bt-sm" id="new_student"><i class="fa fa-plus"></i> Ajouter nouveau</button>
        <br>
        <br>
        <div class="card">
            <div class="card-body">
                            ...
                            <td>
                                <center>
                                    <button class="btn btn-sm btn-outline-primary edit_student"
                                        data-id="<?php echo $row['id'] ?>" type="button"><i class="fa fa-edit"></i>
                                        Editer</button>
                                    <button class="btn btn-sm btn-outline-danger remove_student"
                                        data-id="<?php echo $row['id'] ?>" type="button"><i class="fa fa-trash"></i>
                                        Supprimer</button>
                                </center>
                            </td>
                        </tr>
        ...
        <div class="modal-dialog modal-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title" id="myModallabel">Ajout d'un nouveau candidat</h4>
...
$(document).ready(function() {
    ...
    $('#new_student').click(function() {
        $('#msg').html('')
        $('#manage_student .modal-title').html('Ajout d\'un nouveau candidat')
        ...
        $.ajax({
            ...
            success: function(resp) {
                if (typeof resp != undefined) {
                    ...
                    $('#manage_student .modal-title').html('Editer candidat')
                    $('#manage_student').modal('show')
    ...
    $('.remove_student').click(function() {
        var id = $(this).attr('data-id')
        var conf = confirm('Etes-vous sûr de supprimer ce candidat ?');
        if (conf == true) {
            $.ajax({
    ...
    $('#student-frm').submit(function(e) {
        ...
        $('#student-frm [name="submit"]').html('Patienter...')
        $('#msg').html('')
