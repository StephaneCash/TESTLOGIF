...
<body>
    ...
    <div class="container-fluid admin">
        <div class="col-md-12 alert alert-primary">Liste de questionnaires</div>
        <button class="btn btn-primary bt-sm" id="new_quiz"><i class="fa fa-plus"></i> Ajouter</button>
        <br>
        <br>
        <div class="card">
            <div class="card-body">
                            ...
                            <td>
                                <center>
                                    <a class="btn btn-sm btn-outline-primary edit_quiz"
                                        href="./quiz_view.php?id=<?php echo $row['id'] ?>"><i class="fa fa-gear"></i>
                                        Config</a>
        ...
        <div class="modal-dialog modal-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title" id="myModallabel">Ajouter Nouveau quiz</h4>
                ...
                <form id='quiz-frm'>
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            ...
                            <option value="" selected="" disabled="">Selectionne ici</option>
                            <?php
...
$(document).ready(function() {
    ...
    $('#new_quiz').click(function() {
        $('#msg').html('')
        $('#manage_quiz .modal-title').html('Ajouter Nouveau quiz')
    ...
    $('.remove_quiz').click(function() {
        var id = $(this).attr('data-id')
        var conf = confirm('Etes-vous de vouloir supprimer cette donnée ?');
        if (conf == true) {
            $.ajax({
